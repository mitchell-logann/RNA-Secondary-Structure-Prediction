...
output_dir = Path(f"./outputs/ViennaRNA Outputs/{len(results)}")
...
summary_path = output_dir / f"{len(results)} summary.txt"

with open(summary_path, "w") as f:
    f.write(f"Vienna Baseline Summary For Sample Size {len(results)}\n")
    f.write("=" * 40 + "\n\n")
